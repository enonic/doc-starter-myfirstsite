...
NOTE: *In step 2:* Choose "*My First Site*" starter, and create a *new sandbox* for the project

====
After deploying, you should find an entry similar to this in the XP sandbox log:
